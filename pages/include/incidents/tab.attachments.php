<div class="tab-pane bg-light-gray" id="incidentTab3" role="tabpanel">
    <div class="row pl-3 pr-3">
        <div class="col-md-9 font-ash">
            <div class="d-flex flex-column pl-3 pr-4">
                <div class="d-flex align-items-center">
                    <button class="btn btn-primary btn-xs ml-auto mr-3 mt-3">
                        Download Attachments
                    </button>
                    <button class="btn btn-primary btn-xs mt-3">
                        Add New Attachments
                    </button>
                </div>
        ...
        <div class="col-md-3 bg-white">
            <?php include('include/incidents/incidents.quality-incident.php') ?>
