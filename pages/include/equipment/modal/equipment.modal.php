    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php include('./include/equipment/modal/equipment.modal-step-1.php') ?>
                <?php include('./include/equipment/modal/equipment.modal-step-2.php') ?>
                <?php include('./include/equipment/modal/equipment.modal-step-3.php') ?>
                <?php include('./include/equipment/modal/equipment.modal-step-4.php') ?>
