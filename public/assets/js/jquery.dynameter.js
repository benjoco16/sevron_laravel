(function ( $ ) {
    ...
    $.fn.dynameter = function ( options ) {
        ...
        settings._clrRef3 = 'very-poor';
        settings._clrRef4 = 'poor';
        settings._clrRef5 = 'fair';
        settings._clrRef6 = 'good';
        settings._clrRef7 = 'excellent';
        settings._clrRef8 = 'blank';
            ...
            if (!$this.hasClass('dm-wrapperDiv')) {
                ...
                for (var key in settings.regions) {
                    ...
                    if (currClrRef != settings._clrRef0 &&
                        ...
                        currClrRef != settings._clrRef4 &&
                        currClrRef != settings._clrRef5 &&
                        currClrRef != settings._clrRef6 &&
                        currClrRef != settings._clrRef7 &&
                        currClrRef != settings._clrRef8) {
