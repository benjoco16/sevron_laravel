                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 p-3 text-left">
                                    ...
                                    <div class="row row bg-light-blue sv-portlet ml-0 mr-3">
                                        <div class="col-md-6 col-sm-6 pl-0">
                                            <div class="progress mb-2">
                                                <div class="progress-bar risk-assessment__progress--medium-risk" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>

                                            <div class="progress-label d-flex align-items-center">
                                                <span class="font-ash">
                                                    <span class="font-weight-500">
                                                        <small>Medium Risk</span> <br>
                                                    Before</small>
                                                </span>
                                        ...
                                        <div class="col-md-6 col-sm-6 pr-0">
                                            <div class="progress mb-2">
                                                <div class="progress-bar risk-assessment__progress--low-risk" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                            <div class="progress-label d-flex align-items-center">
                                                <span class="font-ash">
                                                    <span class="font-weight-500">
                                                        <small>Low Risk</span> <br>
                                                    After</small>
                                                </span>
                                                <h2 class="font-rhino pl-2 ml-auto">
                                                    <strong>4</strong>   
                            ...
                            <div class="sv-portlet sv-portlet--bordered mr-3 mt-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-4 d-flex align-items-center">
                                        <img class="hazard__icon" src="{{URL::asset('assets/media/risk/hazard_icon.png')}}">
                            ...
                            <div class="sv-portlet sv-portlet--bordered sv-portlet--bordered-red mr-3 mt-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-4 d-flex align-items-center">
                                        <img class="hazard__icon" src="{{URL::asset('assets/media/risk/emergency_icon.png')}}">

                                        <div class="sv-portlet ml-3 bg-light-gray mt-1">
                                            <p class="mb-0">
                                                <small>Rinse cautiously with water for several minites at eyewash station.</small>
                                            </p>
                                        </div>
                                    </div>

                                    <div class="col-md-6 mt-4 d-flex align-items-center">
                                        <img class="hazard__icon" src="{{URL::asset('assets/media/assessment-wizard/first-aid-green.png')}}">

                                        <div class="sv-portlet ml-3 bg-light-gray mt-1">
                                            <p class="mb-0">
                                                <small>Immediately contact 222.</small>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-10 p-3 text-left">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="sv-portlet bg-light-gray mt-1">
                                        <p class="mb-0">
                                            <small>H315 - Causes skin irritation</small>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="sv-portlet sv-portlet--bordered mr-3 mt-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-4 d-flex align-items-center">
                                        <img class="hazard__icon" src="{{URL::asset('assets/media/assessment-wizard/wash-hands.png')}}">

                                        <div class="sv-portlet ml-3 bg-light-gray mt-1">
                                            <p class="mb-0">
                                                <small>Wash your hands when you've finished</small>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-4 d-flex align-items-center">
                                        <img class="hazard__icon" src="{{URL::asset('assets/media/assessment-wizard/protective-clothing.png')}}">

                                        <div class="sv-portlet ml-3 bg-light-gray mt-1">
                                            <p class="mb-0">
                                                <small>Please use protective clothing such as overalls</small>
                                            </p>
                                        </div>
                                    </div>

                                    <div class="col-md-6 mt-4 d-flex align-items-center">
                                        <img class="hazard__icon" src="{{URL::asset('assets/media/assessment-wizard/protective-gloves.png')}}">

                                        <div class="sv-portlet ml-3 bg-light-gray mt-1">
                                            <p class="mb-0">
                                                <small>Wear suitable protective gloves if there is risk of skin contact when pouring</small>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="sv-portlet sv-portlet--bordered sv-portlet--bordered-red mr-3 mt-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-4 d-flex align-items-center">
                                        ...
                                        <div class="sv-portlet ml-3 bg-light-gray mt-1">
                                            <p class="mb-0">
                                                <small>Rinse skin with water and seek first aid if required.</small>
                                            </p>
                                        </div>
                                    </div>
