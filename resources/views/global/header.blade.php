<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed " >
        <div class="kt-header-mobile__logo">
            <a href="/sevron/pages">
                <img alt="Logo" src="{{URL::asset('assets/media/logos/logo-mobile.png')}}" style="max-width: 40px"/>
            </a>
        </div>
                        ...
                        <div class="kt-container  kt-container--fluid">
                            ...
                            <div class="kt-header__brand " id="kt_header_brand">
                                <div class="kt-header__brand-logo">
                                    <a href="/sevron/pages">
                                        <img alt="Logo" src="{{URL::asset('assets/media/logos/logo-dark.png')}}" height="40"/>
                                    </a>		
                                </div> 
                            </div>
                            <!-- end:: Brand -->	
    ...
    <div class="kt-header__topbar-item dropdown">
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--langs">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                <span class="kt-header__topbar-icon">
                    <img class="" src="{{URL::asset('assets/media/flags/012-uk.svg')}}" alt="" />
                </span>
            </div>
            <div class="dropdown-menu dropdown--dark-full dropdown-menu-fit dropdown-menu-right dropdown-menu-anim">
                ...
                <a href="/sevron/pages/maintenance.php" class="dropdown-menu-item d-flex align-items-center pb-2">
                    <span class="kt-nav__link-icon"><img src="{{URL::asset('assets/media/flags/020-flag.svg')}}" alt="" /></span>
                    <span class="kt-nav__link-text font-white">English</span>
                </a>
                <a href="/sevron/pages/maintenance.php" class="dropdown-menu-item d-flex align-items-center pb-2">
                    <span class="kt-nav__link-icon"><img src=" {{URL::asset('assets/media/flags/016-spain.svg')}}" alt="" /></span>
                ...
                <a href="/sevron/pages/maintenance.php" class="dropdown-menu-item d-flex align-items-center">
                    <span class="kt-nav__link-icon"><img src="{{URL::asset('assets/media/flags/017-germany.svg')}}" alt="" /></span>
