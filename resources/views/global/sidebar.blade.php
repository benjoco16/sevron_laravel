		...
		<div 
			...
			<ul class="kt-menu__nav ">
                <li class="kt-menu__item kt-menu__item--active" aria-haspopup="true">
                    <a href="/sevron/pages" class="kt-menu__link ">
                ...
                <li class="kt-menu__item" aria-haspopup="true">
                    <a href="/sevron/pages/assessment-process.php" class="kt-menu__link ">
                        <span class="kt-menu__link-icon">
                ...
                <li class="kt-menu__item" aria-haspopup="true">
                    <a href="/sevron/pages/substances.php" class="kt-menu__link ">
                        <span class="kt-menu__link-icon">
                ...
                <li class="kt-menu__item" aria-haspopup="true">
                    <a href="/sevron/pages/incidents.php" class="kt-menu__link ">
                        <span class="kt-menu__link-icon">
                ...
                <li class="kt-menu__item" aria-haspopup="true">
                    <a href="/sevron/pages/equipment.php" class="kt-menu__link ">
