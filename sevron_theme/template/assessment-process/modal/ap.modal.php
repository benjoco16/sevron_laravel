    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php include('./template/assessment-process/modal/ap.modal-step-1.php') ?>
                <?php include('./template/assessment-process/modal/ap.modal-step-2.php') ?>
                <?php include('./template/assessment-process/modal/ap.modal-step-3.php') ?>
                <?php include('./template/assessment-process/modal/ap.modal-step-4.php') ?>
